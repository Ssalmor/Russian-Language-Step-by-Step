...
class RVGridAdapter(private var data: ArrayList<ImageAndTextModel>) : RecyclerView.Adapter<RVGridAdapter.ItemHolder>() {

    private var mediaPlayer: MediaPlayer? = null

    class ItemHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var icon: ImageView = itemView.findViewById(R.id.icons_image)
        var text: TextView = itemView.findViewById(R.id.icons_text)
