...
class GrammarFour : Fragment() {
            ...
            itemClickListener = { collectionItem ->
                if(dbRef.child(collectionItem.getOriginalKey()).key.toString().contains("dialog")) {
                    val actionId = resources.getIdentifier(
                        "action_grammarFour_to_grammarThreeExtension",
                        "id",
                    ...
                    val actionId = resources.getIdentifier(
                        "action_grammarFour_to_grammarThreeExtensionTwo",
                        "id",
                        requireContext().packageName
                    )
    ...
    private fun updateRecyclerView() {
        ...
        val expList = listOf(
            R.layout.grammar_four_1_dialog,
            R.layout.grammar_four_2_dialog,
            R.layout.phonetics_four_3_dialog,
            R.layout.grammar_four_4_dialog,
            R.layout.grammar_four_5_dialog,
            R.layout.grammar_four_6_dialog
        )
